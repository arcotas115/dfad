...
-type pool(JFY, JFZ) :: {pool,
        fun((JFY, glisten@internal@handler:loop_message(JFZ), glisten@internal@handler:connection(JFZ)) -> glisten@internal@handler:next(JFY, glisten@internal@handler:loop_message(JFZ))),
        integer(),
        fun((glisten@internal@handler:connection(JFZ)) -> {JFY,
            gleam@option:option(gleam@erlang@process:selector(JFZ))}),
        gleam@option:option(fun((JFY) -> nil)),
        glisten@transport:transport()}.
