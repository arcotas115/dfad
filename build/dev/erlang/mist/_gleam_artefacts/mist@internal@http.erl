...
?DOC(false).
-spec add_date_header(gleam@http@response:response(KYK)) -> gleam@http@response:response(KYK).
...
?DOC(false).
-spec connection_close(gleam@http@response:response(KYN)) -> gleam@http@response:response(KYN).
...
?DOC(false).
-spec keep_alive(gleam@http@response:response(KYQ)) -> gleam@http@response:response(KYQ).
keep_alive(Resp) ->
    gleam@http@response:set_header(
        Resp,
        <<"connection"/utf8>>,
...
?DOC(false).
-spec maybe_keep_alive(gleam@http@response:response(KYT)) -> gleam@http@response:response(KYT).
...
?DOC(false).
-spec add_content_length(boolean(), integer()) -> fun((gleam@http@response:response(KYY)) -> gleam@http@response:response(KYY)).
